...
summary_df.to_csv("results/resultados_media.txt", index=False)
...
plt.title('Gráfico de convergencia del BOA (instancia media)')
plt.xlabel('Iteración')
plt.ylabel('Mejor Valor (fitness)')
plt.grid(True)
plt.tight_layout()
plt.savefig("figures/Convergencia_media.png")
...
plt.title('Boxplot del mejor fitness en 40 ejecuciones (instancia media)')
plt.ylabel('Fitness')
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig("figures/Boxplot_media.png")

plt.figure(figsize=(10, 5))
plt.plot(qmetric_iter, marker='s', linestyle='-', color='green')
plt.title('QMetric por iteración (mejor ejecución, instancia media)')
plt.xlabel('Iteración')
plt.ylabel('QMetric')
plt.grid(True)
plt.tight_layout()
plt.savefig("figures/QMetric_media.png")
