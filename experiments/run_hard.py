...
summary_df.to_csv("results/resultados_dura.txt", index=False)
...
plt.title('Gráfico de convergencia del BOA (instancia dura)')
plt.xlabel('Iteración')
plt.ylabel('Mejor Valor (fitness)')
plt.grid(True)
plt.tight_layout()
plt.savefig("figures/Convergencia_dura.png")
...
plt.title('Boxplot del mejor fitness en 40 ejecuciones (instancia dura)')
plt.ylabel('Fitness')
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig("figures/Boxplot_dura.png")

plt.figure(figsize=(10, 5))
plt.plot(qmetric_iter, marker='s', linestyle='-', color='green')
plt.title('QMetric por iteración (mejor ejecución, instancia dura)')
plt.xlabel('Iteración')
plt.ylabel('QMetric')
plt.grid(True)
plt.tight_layout()
plt.savefig("figures/QMetric_dura.png")
