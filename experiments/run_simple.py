...
summary_df.to_csv("results/resultados_simple.txt", index=False)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("figures/Convergencia_simple.png")
...
plt.tight_layout()
plt.savefig("figures/Boxplot_simple.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("figures/QMetric_simple.png")
